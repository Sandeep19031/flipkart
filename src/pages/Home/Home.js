    ...
    return(
        <div className="homeProductCard">
            ...
            <div className="homeProductCard-description">
                ...
                <p className="homeProductCard-description-productPrice">₹{productPrice}</p>
                <p className="homeProductCard-description-productBrand">{productBrand}</p>
            </div>
        </div>
    );
}
...
function Home() {
    const HomeProductCard_Mobiles = [
        ...
        },
        {
            ...
            productPrice: "17,999",
            productBrand: "realme",
            productImgSrc: "https://rukminim1.flixcart.com/image/416/416/ktbu6q80/mobile/f/s/e/8s-5g-rmx3381-realme-original-imag6zhgra57dtqe.jpeg?q=70"
        }
    ];
    const HomeProductCard_Fashions = [
        {
            ...
            productImgSrc:"https://rukminim1.flixcart.com/image/880/1056/kkec4280/kurta/r/z/r/s-kr452a-metro-fashion-original-imafzr5zyytvgvrp.jpeg?q=50"
        },
        {
            productName: "Women Printed Rayon Straight Kurta",
            productPrice: "399",
            productBrand: "LIBAS",
            productImgSrc: "https://rukminim1.flixcart.com/image/880/1056/k7gikcw0/kurta/q/3/x/xl-8072mj-blue-libas-original-imafpz7gqjhf8thg.jpeg?q=50"
        }
    ];
    return (
        <div>
